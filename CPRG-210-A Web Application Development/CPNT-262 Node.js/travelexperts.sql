...
CREATE TABLE `agencies` (
  ...
  `AgncyPhoto` varchar(500) NOT NULL,
...
INSERT INTO `agencies` (`AgencyId`, `AgncyPhoto`, `AgncyAddress`, `AgncyCity`, `AgncyProv`, `AgncyPostal`, `AgncyCountry`, `AgncyPhone`, `AgncyFax`) VALUES
(1, 'https://loremflickr.com/800/500/travel', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '4032719872'),
(2, 'https://loremflickr.com/800/500/plane', '110 Main Street', 'Okotoks', 'AB', 'T7R3J5', 'Canada', '4035632381', '4035632382');
...
(1328, '2022-06-14 10:39:12', 109, NULL, 1),
(1329, '2022-06-14 12:04:22', 130, NULL, 2),
(1330, '2022-06-14 12:05:09', 152, NULL, 2),
(1331, '2022-06-14 12:34:58', 107, NULL, 2),
(1332, '2022-06-14 12:54:59', 152, NULL, 1);
...
(152, 'Hilmi Ah', 't2y3p6', 'hilmi714@hotmail.com', 'test');
...
(1, 'Caribbean New Year', 'https://imgur.com/Jh14XPb.png', '2017-12-25 00:00:00', '2017-01-04 00:00:00', 'Cruise the Caribbean & Celebrate the New Year.', '4800.0000', '400.0000'),
(2, 'Polynesian Paradise', 'https://imgur.com/8pCwf5Q.png', '2016-12-12 00:00:00', '2016-12-20 00:00:00', '8 Day All Inclusive Hawaiian Vacation', '3000.0000', '310.0000'),
(3, 'Asian Expedition', 'https://imgur.com/PZQ1Uyq.png', '2016-05-14 00:00:00', '2016-05-28 00:00:00', 'Airfaire, Hotel and Eco Tour.', '2800.0000', '300.0000'),
(4, 'European Vacation', 'https://imgur.com/RCdfaiU.png', '2016-11-01 00:00:00', '2016-11-14 00:00:00', 'Euro Tour with Rail Pass and Travel Insurance', '3000.0000', '280.0000'),
(5, 'North African Safari', 'https://i.imgur.com/t074NyZ.png', '2016-05-14 00:00:00', '2016-05-28 00:00:00', '9 Day Expedition In North Africa', '9000.0000', '400.0000'),
(6, 'South American Adventure', 'https://imgur.com/nRpiSuZ.png', '2016-05-14 00:00:00', '2016-05-28 00:00:00', 'A 4 Day Trek Through South Americas Greatest Trail', '3000.0000', '200.0000');
...
--
ALTER TABLE `bookings`
  MODIFY `BookingId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1333;

--
-- AUTO_INCREMENT for table `customers`
--
ALTER TABLE `customers`
  MODIFY `CustomerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;
